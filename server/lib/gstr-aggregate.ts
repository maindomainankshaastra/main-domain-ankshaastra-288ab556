...
export type GstrInvoiceRecord = {
  ...
  invoice_number: string;
  invoice_date: string;
  // The order this invoice was generated from — carried through into
  // every export sheet (Sales Register, B2B/B2CL/CDNR/CDNUR) so each row
  // can be traced back to the exact order it billed.
