...
//   // Slightly smaller text so the layout matches the reference
//   const bodySize = 12.5;
...
//   const nameLabelSize = 12.5;
//   const nameValueSize = 13.5;

//   // Left label
//   const nameLabelX =
//     boxX + boxWidth * 0.25 -
//     fonts.sansBold.widthOfTextAtSize(opts.nameLabel, nameLabelSize) / 2;

//   page.drawText(opts.nameLabel, {
//     x: nameLabelX,
//     y: nameTop - nameRowH / 2 - nameLabelSize * 0.35,
//     size: nameLabelSize,
//     font: fonts.sansBold,
//     color: COLOR.white,
//   });
...
//   const nameValueX =
//     boxX + boxWidth * 0.72 -
//     fonts.sansBold.widthOfTextAtSize(opts.nameValue, nameValueSize) / 2;

//   page.drawText(opts.nameValue, {
//     x: nameValueX,
//     y: nameTop - nameRowH / 2 - nameValueSize * 0.35,
//     size: nameValueSize,
//     font: fonts.sansBold,
//     color: COLOR.white,
//   });
...
//   // ============================================================
//   // 2. TOTAL / REDUCED TO BOX
//   // ============================================================

//   const gapAfterName = 12;
//   const totalsRowH = 46;

//   const totalsTop =
//     nameTop - nameRowH - gapAfterName;

//   drawRoundedRect(page, {
//     x: boxX,
//     y: totalsTop - totalsRowH,
//     width: boxWidth,
//     height: totalsRowH,
//     radius: 16,
//     color: COLOR.blushPanel,
...
//       {
//         label: "Total",
//         value: String(opts.total),
//       },
//       {
//         label: "Reduced To",
//         value: String(opts.reducedTo),
//       },
//     ];
...
//         boxX +
//         colW / 2 -
//         fonts.sansBold.widthOfTextAtSize(cols[0].label, labelSize) / 2,
//       y:
//         totalsTop -
//         totalsRowH / 2 -
//         labelSize * 0.35,
...
//     // Total value
//     page.drawText(cols[0].value, {
//       x:
//         boxX +
//         colW * 1.5 -
//         fonts.sansBold.widthOfTextAtSize(cols[0].value, valueSize) / 2,
//       y:
//         totalsTop -
//         totalsRowH / 2 -
//         valueSize * 0.35,
...
//     // Reduced To label
//     page.drawText(cols[1].label, {
//       x:
//         boxX +
//         colW * 2.5 -
//         fonts.sansBold.widthOfTextAtSize(cols[1].label, labelSize) / 2,
//       y:
//         totalsTop -
//         totalsRowH / 2 -
//         labelSize * 0.35,
...
//     // Reduced To value
//     page.drawText(cols[1].value, {
//       x:
//         boxX +
//         colW * 3.5 -
//         fonts.sansBold.widthOfTextAtSize(cols[1].value, valueSize) / 2,
//       y:
//         totalsTop -
//         totalsRowH / 2 -
//         valueSize * 0.35,
...
//         boxX +
//         boxWidth / 2 -
//         fonts.sansBold.widthOfTextAtSize(txt, size) / 2,
//       y:
//         totalsTop -
//         totalsRowH / 2 -
//         size * 0.35,
...
//   // ============================================================
//   // 3. WHAT THIS REPRESENTS BOX
//   // ============================================================

//   // IMPORTANT:
//   // Reference design has a larger breathing space between
//   // Total box and "What This Represents".

//   const gapBeforeContent = 42;
...
//   // ============================================================
//   // 4. CENTERED "WHAT THIS REPRESENTS" PILL
//   // ============================================================
...
//   const bannerX =
//     boxX + boxWidth / 2 - bannerW / 2;

//   const bannerY =
//     contentBoxTop - bannerH / 2;
...
//   const bannerText = "WHAT THIS REPRESENTS";
//   const bannerTextSize = 10.5;
...
//     x: 62,
//     y: contentBoxTop - TYPE.cardPadding - 8,
//     font: fonts.sans,
//     size: bodySize,
//     maxWidth: innerWidth,
//     lineHeight,
//     gap: TYPE.bulletGap + 3,
//     color: COLOR.ink,
//   });
// }
...
/** Page 15 — minimal back cover: centered logo + website pill + report ID. */
function drawBackCoverPage(page: PDFPage, fonts: Fonts, assets: Assets,
